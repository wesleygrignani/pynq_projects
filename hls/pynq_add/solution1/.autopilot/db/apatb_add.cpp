...
extern "C"
void add_hw_stub_wrapper(hls::sim::Byte<4>, hls::sim::Byte<4>, void*);

extern "C"
void apatb_add_hw(hls::sim::Byte<4> __xlx_apatb_param_a, hls::sim::Byte<4> __xlx_apatb_param_b, void* __xlx_apatb_param_c)
{
  ...
  try {
    ...
    add_hw_stub_wrapper(__xlx_apatb_param_a, __xlx_apatb_param_b, __xlx_apatb_param_c);
