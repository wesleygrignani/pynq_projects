...
set IPName      "add"
set Version     "1.0"
set DisplayName "scalar_add"
set Revision    "2112904790"
set Description "adder ip"
set Device      "zynq"
set AutoFamily  ""
...
set xo_kernel_name "add"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Users/wesle/Desktop/pynq/hls/pynq_add/solution1"
set debug_dir "C:/Users/wesle/Desktop/pynq/hls/pynq_add/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {add_control_s_axi
add
}
set kernel_xo ""
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 a W 0x0 "Data signal of a" {{0 32 a W 0 "Bit 31 to 0 of a"}}} {0x18 b W 0x0 "Data signal of b" {{0 32 b W 0 "Bit 31 to 0 of b"}}} {0x20 c R 0x0 "Data signal of c" {{0 32 c R 0 "Bit 31 to 0 of c"}}} {0x24 c_ctrl R 0x0 "Control signal of c" {{0 1 c_ap_vld R 0 "Control signal c_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
