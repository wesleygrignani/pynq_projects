...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 1 \
			corename example_control_axilite \
			name example_control_s_axi \
			ports {$port_control} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler example_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { A_TVALID { I 1 bit } A_TREADY { O 1 bit } A_TLAST { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { B_TREADY { I 1 bit } B_TVALID { O 1 bit } B_TLAST { O 1 vector } } \
} "
} else {
...
# RegSlice definition:
set ID 10
set RegSliceName example_regslice_both
set RegSliceInstName example_regslice_both_U
set CoreName ap_simcore_example_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
...
set InstName example_flow_control_loop_pipe_U
set CompName example_flow_control_loop_pipe
