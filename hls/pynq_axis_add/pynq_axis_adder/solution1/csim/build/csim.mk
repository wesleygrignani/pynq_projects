...
IFLAG += -D__DSP48E1__
IFLAG += -DALLOW_EMPTY_HLS_STREAM_READS -Wno-unknown-pragmas 
IFLAG += -g
IFLAG += -DNT
...
$(ObjDir)/example_test.o: ../../../example_test.cpp $(ObjDir)/.dir
	...
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -DALLOW_EMPTY_HLS_STREAM_READS -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \
